                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <h5 class="card-title mb-1">Upload Photos</h5>
                                    <p class="card-text text-muted">Upload and import photos into the system</p>
                                </div>
                            </div>
                            <a href="{{ route('settings.upload.photos.create') }}" class="btn btn-outline-primary btn-sm w-100">
                                <i class="bi bi-arrow-right"></i> Upload
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                <i class="bi bi-wikipedia fs-2 text-success me-3"></i>
                                <div>
                                    <h5 class="card-title mb-1">Wikipedia Import</h5>
                                    <p class="card-text text-muted">Bulk import descriptions and sources from Wikipedia</p>
                                </div>
                            </div>
                            <a href="{{ route('admin.import.wikipedia.index') }}" class="btn btn-outline-success btn-sm w-100">
                                <i class="bi bi-arrow-right"></i> Import
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                <i class="bi bi-geo-alt-fill fs-2 text-info me-3"></i>
                                <div>
                                    <h5 class="card-title mb-1">Plaque Import</h5>
                                    <p class="card-text text-muted">Import commemorative plaques and memorials</p>
                                </div>
                            </div>
                            <a href="{{ route('admin.import.blue-plaques.index') }}" class="btn btn-outline-info btn-sm w-100">
                                <i class="bi bi-arrow-right"></i> Import
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <h5 class="card-title mb-1">Span Metrics</h5>
                                    <p class="card-text text-muted">View span completeness scores and analytics</p>
                                </div>
                            </div>
                            <a href="{{ route('admin.metrics.index') }}" class="btn btn-outline-warning btn-sm w-100">
                                <i class="bi bi-arrow-right"></i> View Metrics
                            </a>
                        </div>
                    </div>
                </div>
