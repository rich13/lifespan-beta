...
<div class="modal fade" id="aboutLifespanModal" tabindex="-1" aria-labelledby="aboutLifespanModalLabel" aria-hidden="true" style="z-index: 1055;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="aboutLifespanModalLabel">
                    <i class="bi bi-bar-chart-steps me-2"></i>About Lifespan
                </h5>
