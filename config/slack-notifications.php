...
return [
    ...
    */
    'events' => [
        ...
        'user_signed_in' => env('SLACK_NOTIFY_USER_SIGNED_IN', true),
        'password_reset_requested' => env('SLACK_NOTIFY_PASSWORD_RESET_REQUESTED', true),
        'password_reset_completed' => env('SLACK_NOTIFY_PASSWORD_RESET_COMPLETED', true),
        'sign_in_blocked' => env('SLACK_NOTIFY_SIGN_IN_BLOCKED', true),
